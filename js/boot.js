...
import { initFirebase, loadData, cleanMockDataFromExisting, fixDuplicateIdsAndCounters, forceWipeAllData } from './firebase.js';
...
export async function bootApp() {
  initFirebase();
  await loadData();
  cleanMockDataFromExisting();
  fixDuplicateIdsAndCounters();
